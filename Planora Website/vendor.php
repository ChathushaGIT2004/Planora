...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p>Join our platform and connect with thousands of event planners looking for your services. Showcase your expertise, manage bookings, and grow your business.</p>
            <a href="vendor-registration.php" class="cta-button">Become a Vendor</a>
        </div>
    </section>
        ...
        <div class="section-container">
            <div class="footer-content">
                <div class="footer-section">
                    <h3>About Planora</h3>
                    <p>Connecting event planners with the best vendors to create unforgettable experiences.</p>
                </div>
                <div class="footer-section">
                    <h3>Quick Links</h3>
                    <ul>
